    ...
    <div>
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-5xl mb-8">About Locow Tech</h1>
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                Locow Tech is a leading Cameroonian technology company specializing in intelligent solutions,
                consulting, cybersecurity, technological services, eco-construction, finance, and agricultural
                technology across Africa.
              </p>
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                Founded with a vision to drive Africa's digital transformation, we combine global best practices
                with deep local expertise to deliver solutions that work in the African context.
              </p>
