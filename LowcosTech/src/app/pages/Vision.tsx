...
export function Vision() {
  useSEO({
    ...
    description: `La vision de LowCosTech : devenir le partenaire technologique le plus fiable dAfrique pour la transformation numérique durable.`,
    path: '/vision',
    schemaType: 'WebPage',
  });
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-neutral-600 mb-12 max-w-3xl">
            To be the most trusted technology partner in developing countries, driving digital transformation and sustainable
            growth worldwide.
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-brand-terracotta">
              ...
              <p className="text-neutral-600">
                Pioneering solutions that address global challenges with innovative technology.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-brand-terracotta">
              ...
              <p className="text-neutral-600">
                Prioritize collaboration and co-creation to achieve success.
              </p>
            </div>
          </div>
        </div>
