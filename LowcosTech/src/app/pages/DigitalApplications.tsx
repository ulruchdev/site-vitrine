...
export function DigitalApplications() {
  useSEO({
    ...
    description: `Solutions logicielles personnalisées pour entreprises africaines : apps mobiles, web, ERP, SaaS. LowCosTech à Yaoundé, Cameroun.`,
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl leading-relaxed">
            Custom software solutions tailored for modern businesses, from mobile apps to enterprise platforms.
            We build digital products that solve real problems and drive measurable business outcomes worldwide.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                At LowCosTech, we specialize in designing and developing custom digital applications that
                unique needs of modern businesses and organizations. Our team of experienced
              ...
              <p className="text-lg text-neutral-600 mb-8 leading-relaxed">
                ...
                and experience to bring your vision to life anywhere in the world.
              </p>
              <Link
                to="/contact"
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
              Real-world applications making a difference worldwide.
            </p>
          </div>
