    ...
    <section className="py-20 px-6 bg-neutral-50">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <SectionLabel>About LowCosTech</SectionLabel>
            <h2 className="text-4xl md:text-5xl mb-6">Building the Digital Future</h2>
            <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
              LowCosTech is a Cameroonian technology company specializing in delivering comprehensive digital solutions tailored to the challenges and opportunities of the market, particularly in Africa.
