...
export function Cybersecurity() {
  useSEO({
    ...
    description: `Solutions complètes de cybersécurité pour entreprises africaines : audits, pentest, surveillance 24/7, conformité GDPR. LowCosTech.`,
      ...
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl leading-relaxed">
            ...
            evolving cyber threats. Built with global security standards for worldwide protection.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-neutral-600 mb-6 leading-relaxed">
                In an increasingly connected world, cybersecurity is not optional—it's essential. LowCosTech
