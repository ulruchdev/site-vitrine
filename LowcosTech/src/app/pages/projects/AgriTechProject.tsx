...
export function AgrAIAProject() {
  return (
    <div>
      <section className="relative h-[600px] overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-green-900/80 to-emerald-900/70 z-10"></div>
        <img src="https://images.unsplash.com/photo-1746014929708-fcb859fd3185?w=1600" alt="AgrAIA" className="absolute inset-0 w-full h-full object-cover" />
        <div className="relative z-20 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <h1 className="text-6xl md:text-7xl text-white mb-6">AgrAIA Platform</h1>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-neutral-600 mb-8 max-w-3xl leading-relaxed">
            Our AgrAIA platform delivers actionable agricultural insights via SMS, voice, and mobile apps—optimizing
      ...
      <section className="py-20 px-6 bg-neutral-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to="/services/AgrAIA" className="inline-flex items-center gap-2 px-8 py-4 text-white rounded-lg bg-brand-orange">
