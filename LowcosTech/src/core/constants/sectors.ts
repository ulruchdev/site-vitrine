...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    description: 'Sustainable building solutions for green development.',
  ...
  },
  {
    ...
    accentColor: BRAND.orange,
    href: '/services/AgrAIA',
  },
];

/** Sectors shown on the Home page Business Sectors section (6 items, no AgrAIA) */
