...
export function Finance() {
  useSEO({
    ...
    description: `Solutions fintech pour la finance inclusive en Afrique : mobile money, paiements digitaux, microfinance. Locow Tech Cameroun.`,
    ...
    <div>
      <section className="relative h-[500px] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 h-full flex flex-col justify-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl">Innovative fintech solutions for mobile money, payment processing, and financial inclusion across Africa.</p>
        </div>
      </section>
