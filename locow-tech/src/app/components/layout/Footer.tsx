    ...
    <footer className="bg-neutral-900 text-white" aria-label="Pied de page">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          {/* Brand */}
          <div>
            <Link to="/" aria-label="Locow Tech — Accueil">
              <img src={logoImg} alt="Locow Tech" className="h-12 w-auto mb-4" />
            </Link>
            <p className="text-sm text-neutral-400 mb-2">Smart Solutions for African Innovation</p>
            <p className="text-sm text-neutral-400">
              Leading technology provider across Cameroon and Africa.
            </p>
          </div>
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-2 text-sm text-neutral-400 mb-6">
              ...
              <li>
                <a href="mailto:locowtech237@gmail.com" className="hover:text-white transition-colors">
                  locowtech237@gmail.com
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-neutral-400 text-center md:text-left">
            © {new Date().getFullYear()} Locow Tech. All rights reserved. Proudly serving Cameroon and Africa.
          </p>
